...
def inspect_contributions(file_path="npz_files/camera_data.npz"):
    ...
    thresholds = [0.0001, 0.0005, 0.001, 0.0025, 0.005, 0.0075, 0.01, 0.025, 0.05]
    ...
    print(f"  Totaal aantal labels: {num_cams * num_gaussians:,}")
    print(f"  Actieve (niet-nul) labels: {total_active:,}")
    print(f"  Maximale waarde gevonden: {global_max:.4f}") # <--- Output van de max
    print("-" * 40)
